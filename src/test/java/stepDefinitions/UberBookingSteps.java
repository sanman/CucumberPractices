...
public class UberBookingSteps {
	...
	@Given("User wants to select a car type {string} from app")
	public void user_wants_to_select_a_car_type_from_app(String carType) {
	...
	/*
	 * @Then("User pays {int} USD") public void user_pays_usd(Integer price) {
